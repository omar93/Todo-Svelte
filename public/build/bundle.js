...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-nssg3i");
    			add_location(img, file$5, 5, 4, 99);
    			attr_dev(p, "class", "title svelte-nssg3i");
    			add_location(p, file$5, 6, 1, 150);
    			attr_dev(div0, "class", "menu svelte-nssg3i");
    			add_location(div0, file$5, 7, 1, 189);
    			attr_dev(div1, "class", "header svelte-nssg3i");
    ...
    const colorStore = persistStore('Color', '#fffff');
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			label = element("label");
    			label.textContent = "Todo Background Color";
    			attr_dev(input_1, "type", "color");
    			add_location(input_1, file$4, 8, 2, 230);
    			attr_dev(label, "for", "head");
    			add_location(label, file$4, 9, 2, 343);
    			add_location(div0, file$4, 7, 1, 221);
    			attr_dev(div1, "id", "menu");
    			attr_dev(div1, "class", "svelte-1b1st8e");
    			add_location(div1, file$4, 6, 0, 128);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			/*input_1_binding*/ ctx[2](input_1);
    			set_input_value(input_1, /*$colorStore*/ ctx[1]);
    			append_dev(div0, t0);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input_1, "change", /*change_handler*/ ctx[4], false, false, false)
    				];
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				...
    				if (!div1_intro) div1_intro = create_in_transition(div1, fly, { x: 200, duration: 500 });
    				div1_intro.start();
    			});
    		...
    		o: function outro(local) {
    			...
    			div1_outro = create_out_transition(div1, fly, { x: 200, duration: 500 });
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div1);
    			/*input_1_binding*/ ctx[2](null);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	let $colorStore;
    	validate_store(colorStore, "colorStore");
    	component_subscribe($$self, colorStore, $$value => $$invalidate(1, $colorStore = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	function input_1_input_handler() {
    		$colorStore = this.value;
    		colorStore.set($colorStore);
    	}

    	const change_handler = () => colorStore.set(input.value);
    	$$self.$capture_state = () => ({ fly, colorStore, input, $colorStore });
    	...
    	return [input, $colorStore, input_1_binding, input_1_input_handler, change_handler];
    }
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "center svelte-j6hp0h");
    			add_location(span, file$3, 36, 8, 1164);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(span, "click", stop_propagation(/*updateTodo*/ ctx[7]), false, false, true);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-j6hp0h");
    			add_location(input, file$3, 33, 12, 1052);
    			attr_dev(form, "id", "form");
    			attr_dev(form, "class", "svelte-j6hp0h");
    			add_location(form, file$3, 32, 8, 986);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, form, anchor);
    			append_dev(form, input);
    			set_input_value(input, /*newTodo*/ ctx[4]);

    			if (!mounted) {
    				dispose = [
    					listen_dev(input, "input", /*input_input_handler*/ ctx[9]),
    					listen_dev(form, "submit", prevent_default(/*editTodo*/ ctx[6]), false, true, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*newTodo*/ 16 && input.value !== /*newTodo*/ ctx[4]) {
    				set_input_value(input, /*newTodo*/ ctx[4]);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$3(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*editable*/ ctx[3]) return create_if_block$1;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", span0_class_value = "" + (null_to_empty(/*done*/ ctx[1] ? "done" : "hidden") + " svelte-j6hp0h"));
    			add_location(span0, file$3, 30, 4, 894);
    			attr_dev(span1, "id", "editButton");
    			attr_dev(span1, "class", "center svelte-j6hp0h");
    			add_location(span1, file$3, 39, 8, 1312);
    			attr_dev(span2, "id", "removeButton");
    			attr_dev(span2, "class", "center svelte-j6hp0h");
    			add_location(span2, file$3, 40, 8, 1405);
    			attr_dev(div, "id", "buttonContainer");
    			attr_dev(div, "class", "svelte-j6hp0h");
    			add_location(div, file$3, 38, 4, 1275);
    			set_style(li, "background-color", /*colorValue*/ ctx[2]);
    			attr_dev(li, "class", "svelte-j6hp0h");
    			add_location(li, file$3, 29, 0, 769);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(span1, "click", stop_propagation(/*editTodo*/ ctx[6]), false, false, true),
    					listen_dev(span2, "click", stop_propagation(/*removeTodo*/ ctx[5]), false, false, true)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*done*/ 2 && span0_class_value !== (span0_class_value = "" + (null_to_empty(/*done*/ ctx[1] ? "done" : "hidden") + " svelte-j6hp0h"))) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	colorStore.subscribe(col => {
    		$$invalidate(2, colorValue = col);
    	});

    	const removeTodo = () => dispatch("remove", id);

    	const editTodo = () => {
    		$$invalidate(3, editable = !editable);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("id" in $$props) $$invalidate(8, id = $$props.id);
    		if ("done" in $$props) $$invalidate(1, done = $$props.done);
    		if ("colorValue" in $$props) $$invalidate(2, colorValue = $$props.colorValue);
    		if ("editable" in $$props) $$invalidate(3, editable = $$props.editable);
    		if ("newTodo" in $$props) $$invalidate(4, newTodo = $$props.newTodo);
    	};
    ...
    class Todo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { todo: 0, id: 8, done: 1 });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 15, 0, 350);
    			attr_dev(div1, "id", "headerContainer");
    			attr_dev(div1, "class", "svelte-1e919ux");
    			add_location(div1, file, 20, 0, 425);
    			attr_dev(div2, "id", "listContainer");
    			attr_dev(div2, "class", "svelte-1e919ux");
    			add_location(div2, file, 24, 1, 518);
    			attr_dev(div3, "id", "formContainer");
    			attr_dev(div3, "class", "svelte-1e919ux");
    			add_location(div3, file, 28, 1, 577);
    			attr_dev(div4, "id", "parent");
    			attr_dev(div4, "class", "svelte-1e919ux");
    			add_location(div4, file, 23, 0, 499);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
