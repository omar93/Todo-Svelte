...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "title svelte-u1bsfi");
    			add_location(p, file$5, 5, 1, 96);
    			attr_dev(div0, "class", "menu svelte-u1bsfi");
    			add_location(div0, file$5, 6, 1, 135);
    			attr_dev(div1, "class", "header svelte-u1bsfi");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$1, 26, 0, 658);
    			attr_dev(input, "class", "input svelte-15beb05");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Todo");
    			add_location(input, file$1, 28, 4, 780);
    			attr_dev(button1, "class", "add svelte-15beb05");
    			add_render_callback(() => /*button1_elementresize_handler*/ ctx[6].call(button1));
    			add_location(button1, file$1, 29, 4, 863);
    			attr_dev(form, "class", "svelte-15beb05");
    			add_location(form, file$1, 27, 0, 743);
    			attr_dev(div, "class", "svelte-15beb05");
    			add_location(div, file$1, 25, 0, 651);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			button1_resize_listener = add_resize_listener(button1, /*button1_elementresize_handler*/ ctx[6].bind(button1));

    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*removeAll*/ ctx[3], false, false, false),
    					listen_dev(input, "input", /*input_input_handler*/ ctx[5]),
    					listen_dev(button1, "click", /*addTodo*/ ctx[2], false, false, false),
    					listen_dev(form, "submit", self(/*addTodo*/ ctx[2]), false, false, false)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ("todoTextLength" in $$props) $$invalidate(4, todoTextLength = $$props.todoTextLength);
    	};
    ...
    class Form extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { todoTextLength: 4 });
    		...
    		if (/*todoTextLength*/ ctx[4] === undefined && !("todoTextLength" in props)) {
