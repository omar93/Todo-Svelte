...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$6, 5, 4, 99);
    			attr_dev(p, "class", "title svelte-3fjf08");
    			add_location(p, file$6, 6, 1, 150);
    			attr_dev(div0, "class", "menu svelte-3fjf08");
    			add_location(div0, file$6, 7, 1, 189);
    			attr_dev(div1, "class", "header svelte-3fjf08");
    			add_location(div1, file$6, 4, 0, 73);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$5, 4, 4, 44);
    			attr_dev(div, "id", "menu");
    			attr_dev(div, "class", "svelte-3qbcwx");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", span0_class_value = "" + ((/*done*/ ctx[0] ? "done" : "hidden") + " right-border" + " svelte-16wgrxq"));
    			add_location(span0, file$4, 15, 4, 488);
    			attr_dev(span1, "id", "text");
    			attr_dev(span1, "class", "center right-border svelte-16wgrxq");
    			add_location(span1, file$4, 16, 4, 568);
    			attr_dev(span2, "id", "button");
    			attr_dev(span2, "class", "center svelte-16wgrxq");
    			add_location(span2, file$4, 18, 8, 670);
    			attr_dev(div, "id", "buttonContainer");
    			attr_dev(div, "class", "svelte-16wgrxq");
    			add_location(div, file$4, 17, 4, 633);
    			attr_dev(li, "class", "svelte-16wgrxq");
    			add_location(li, file$4, 14, 0, 364);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*done*/ 1 && span0_class_value !== (span0_class_value = "" + ((/*done*/ ctx[0] ? "done" : "hidden") + " right-border" + " svelte-16wgrxq"))) {
    ...
    class Todo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { todo: 1, id: 4, done: 0 });
    ...
    /* src\components\Todov2.svelte generated by Svelte v3.38.2 */

    const file$3 = "src\\components\\Todov2.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$3, 4, 4, 36);
    			add_location(li, file$3, 3, 0, 26);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Todov2", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Todov2> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class Todov2 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_each_block(ctx) {
    	...
    	todov2 = new Todov2({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(todo.$$.fragment);
    			t = space();
    			create_component(todov2.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(todo, target, anchor);
    			insert_dev(target, t, anchor);
    			mount_component(todov2, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    		...
    		i: function intro(local) {
    			...
    			transition_in(todov2.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(todo.$$.fragment, local);
    			transition_out(todov2.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(todo, detaching);
    			if (detaching) detach_dev(t);
    			destroy_component(todov2, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(17:4) {#each $todoStore as todo}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$2, 15, 0, 428);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", div0_class_value = "" + (null_to_empty(/*isHidden*/ ctx[0] ? "hidden" : "") + " svelte-1bbumma"));
    			add_location(div0, file, 12, 0, 350);
    			attr_dev(div1, "id", "listContainer");
    			attr_dev(div1, "class", "svelte-1bbumma");
    			add_location(div1, file, 17, 1, 422);
    			attr_dev(div2, "id", "formContainer");
    			attr_dev(div2, "class", "svelte-1bbumma");
    			add_location(div2, file, 21, 1, 481);
    			attr_dev(main, "class", "svelte-1bbumma");
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*isHidden*/ 1 && div0_class_value !== (div0_class_value = "" + (null_to_empty(/*isHidden*/ ctx[0] ? "hidden" : "") + " svelte-1bbumma"))) {
